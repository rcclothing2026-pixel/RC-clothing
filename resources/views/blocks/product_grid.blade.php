        ...
        {{-- Horizontal-scroll carousel (rastah.co style) — ~4.5 cards visible
            ...
            <section class="bg-white {{ $padClass }}">
                <div class="mx-auto flex {{ $containerClass }} items-end justify-between gap-4 border-t border-brand-100 px-4 py-6 sm:px-6 sm:py-8">
                    ...
                    <a href="{{ $shopAllLink }}"
                       class="shrink-0 border-b border-brand-900 pb-0.5 text-sm font-medium text-brand-900 underline-offset-4 transition hover:opacity-70">{{ __('View All') }}</a>
                </div>
                <div class="relative">
                    <div id="{{ $carouselId }}"
                    ...
                    <button type="button" data-marquee-prev="{{ $carouselId }}" aria-label="{{ __('Previous') }}"
                    ...
                    <button type="button" data-marquee-next="{{ $carouselId }}" aria-label="{{ __('Next') }}"
        ...
        <section class="mx-auto {{ $containerClass }} {{ $padClass }} px-4 sm:px-6">
            @if ($heading !== '')
                <div class="reveal mb-8 flex items-end justify-between">
                    ...
                    <a href="{{ $shopAllLink }}" class="text-sm font-medium text-accent-600 hover:underline">{{ __('View All') }}</a>
                </div>
            @endif
