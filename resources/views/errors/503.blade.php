...
@section('title', 'Back Soon | Racket Club')
...
@section('content')
    <div class="mx-auto flex max-w-md flex-col items-center px-4 py-24 text-center">
        ...
        <h1 class="text-xl font-bold uppercase tracking-wide text-brand-900">WE'LL BE BACK SHORTLY</h1>
        <p class="mt-2 text-sm text-brand-500">The site is being updated. Please check back in a little while.</p>
