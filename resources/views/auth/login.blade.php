    ...
    <div class="flex min-h-[80vh] items-center justify-center px-4 py-16 sm:px-6">
        <div class="w-full max-w-sm">
            ...
            <div class="mb-8 text-center">
                ...
                <h1 class="mt-4 text-xl font-bold text-brand-900">خوش آمدید</h1>
                <p class="mt-1.5 text-sm text-brand-500">شماره موبایل خود را وارد کنید تا کد تایید ارسال شود.</p>
            </div>
            ...
            <div class="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-brand-100">
                ...
                <form action="{{ route('login.otp') }}" method="POST" class="space-y-5">
                    @csrf
                    <div>
                        <label for="phone" class="mb-1.5 block text-sm font-medium text-brand-700">شماره موبایل</label>
                        <input id="phone" type="tel" name="phone" value="{{ old('phone') }}" placeholder="۰۹۱۲ *** ****" dir="ltr"
                               inputmode="numeric"
                ...
                <p class="mt-5 text-center text-xs text-brand-400 leading-6">
                    با ورود، <a href="{{ route('page', 'terms') }}" class="text-accent-600 hover:underline">قوانین و مقررات</a> فروشگاه چیاکو را می‌پذیرید.
                </p>
            </div>

            <div class="mt-4 text-center">
                <a href="{{ route('shop.index') }}" class="text-sm text-brand-400 transition hover:text-brand-600">ادامه به عنوان مهمان ← رفتن به فروشگاه</a>
            </div>
